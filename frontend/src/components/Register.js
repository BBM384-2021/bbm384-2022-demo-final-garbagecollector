...
export default function BasicTextFields() {
    ...
    const [PasswordOpen, setPasswordWarning] = React.useState(false);
    ...
    const submitNew=(e)=>{
        e.preventDefault()
        const user={username, password, email, type}
        console.log(user)
    ...
    ><TextField id="outlined-basic1" label="Email" variant="outlined" fullWidth
     ...
     <TextField id="outlined-basic3" label="Type" variant="outlined" fullWidth
                   value={type}
